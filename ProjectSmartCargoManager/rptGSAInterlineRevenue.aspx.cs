...
{
    public partial class rptGSAInterlineRevenue : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                Session["GSAInterlineReport"] = null;
        ...
        protected void btnList_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                object[] param = { fromdate, todate, txtGSACode.Text.Trim() };
                string[] pname = { "fromdate", "todate", "GSACode" };
                SqlDbType[] QueryTypes = { SqlDbType.VarChar, SqlDbType.VarChar, SqlDbType.VarChar };



                ds = da.SelectRecords("spGSAInterlineRevenue", pname, param, QueryTypes);
                ...
                if (ds != null)
                {
                    if (ds.Tables[0].Rows.Count > 0)
                    {
                        ...
                        //Session["GSAInterlineReport"] = ds.Tables[0];
                        ...
                        ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Reports/rptGSARevenueInterline.rdlc");
                        ReportDataSource datasource = new ReportDataSource("rptGSARevenueInterline_DataTable2", dt);
        ...
        private void SaveUserActivityLog(string ErrorLog)
        {
            ...
            objBAL.SaveUserActivityLog(Convert.ToString(Session["IpAddress"]), Session["UserName"].ToString(), "GSA Revenue Share", Convert.ToDateTime(Session["IT"]), Param, ErrorLog, Session["Station"].ToString());
        }
        protected void btnClear_Click(object sender, EventArgs e)
        {
            Response.Redirect("~/rptGSAInterlineRevenue.aspx", false);
        }
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if ((DataSet)Session["GSAInterlineReport"] == null)
                    GetData();

                dt = ((DataSet)Session["GSAInterlineReport"]).Tables[0];
              

                if (Session["GSAInterlineReport"] == null && dt == null)
                {
                    lblStatus.Text = "No records found";
                    lblStatus.ForeColor = Color.Red;
                ...
                Session["GSAInterlineReport"] = null;
                string attachment = "attachment; filename=GSAInterlineRevenue.xls";
