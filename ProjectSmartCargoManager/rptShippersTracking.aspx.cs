...
{
    public partial class rptShippersTracking : System.Web.UI.Page
    {
        ...
        protected void btnList_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                Session["rptShippersTracking"] = null;
                ReportViewer1.Visible = false;
                ...
                object[] param = { fromdate, todate, ddlStation.SelectedItem.Value.ToString(), ddlStationType.SelectedItem.Value.ToString(), ddlCarrier.SelectedItem.Value.Trim(),txtShipperCode.Text.Trim() };
                string[] pname = { "fromdate", "todate", "Station", "StationType", "Carrier", "ShipperCode" };
                ...
                ds = da.SelectRecords("spShippersTrackingReport", pname, param, QueryTypes);
                ...
                if (ds != null)
                {
                    if (ds.Tables[0].Rows.Count > 0)
                    {
                        ...
                        Session["rptShippersTracking"] = ds.Tables[0];
                        //Logo
                        try
                        {
                        ...
                        ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Reports/rptShippersTracking.rdlc");
                        ReportDataSource datasource = new ReportDataSource("rptShippersTracking_DataTable1", dt);
        ...
        private void SaveUserActivityLog(string ErrorLog)
        {
            ...
            objBAL.SaveUserActivityLog(Convert.ToString(Session["IpAddress"]), Session["UserName"].ToString(), "Shippers Tracking Report", Convert.ToDateTime(Session["IT"]), Param, ErrorLog, Session["Station"].ToString());
        }
        protected void btnClear_Click(object sender, EventArgs e)
        {
            Response.Redirect("~/rptShippersTracking.aspx", false);
        }
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if ((DataTable)Session["rptShippersTracking"] == null)
                    GetData();

                dt = (DataTable)Session["rptShippersTracking"];

                if (Session["rptShippersTracking"] == null && dt == null)
                {
                    lblStatus.Text = "No records found";
                    lblStatus.ForeColor = Color.Red;
                ...
                string attachment = "attachment; filename=ShippersTrackingReport.xls";
