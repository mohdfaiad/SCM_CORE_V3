<%@ Page Title="" Language="C#" MasterPageFile="~/SmartCargoMaster.Master" AutoEventWireup="true" CodeBehind="rptCollectedCRSalesMonth.aspx.cs" Inherits="ProjectSmartCargoManager.rptCollectedCRSalesMonth" %>
...
<asp:Label ID="lblStatus" runat="server" BackColor="White" Font-Bold="True" Font-Size="Large"></asp:Label>
 ...
 <h1>Collected Credit Sales Report</h1>

<div class="botline">
<table>
<tr>
<td class="style1">Agent</td>
<td class="style1"> 
