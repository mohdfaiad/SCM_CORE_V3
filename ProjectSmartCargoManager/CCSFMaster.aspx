<%@ Page Language="C#"  AutoEventWireup="true"  Title="CCFS Master" CodeBehind="CCSFMaster.aspx.cs"  MasterPageFile="~/SmartCargoMaster.Master" Inherits="ProjectSmartCargoManager.CCFSMaster"%>
...
<td colspan=2>
   ...
   <h1>&nbsp;</h1>
    ...
    <asp:GridView ID="grvCCSFMaster" runat="server" AutoGenerateColumns="False" Width="100%"
            ...
            onpageindexchanging="grvCCSFMaster_PageIndexChanging">
...
<RowStyle CssClass="RowStyle" HorizontalAlign ="Center" ></RowStyle>
                                 ...
                                 <asp:TemplateField HeaderText="CCFS Code">    
                                   <ItemTemplate>    
                                    <asp:TextBox ID="txtCCSFCode" runat="server" Text = '<%# Eval("CCSFCode") %>'  Width="60px"></asp:TextBox> 
                                   </ItemTemplate>
                                 </asp:TemplateField>
                                 
                                 <asp:TemplateField HeaderText="CCFS Name">    
                                   <ItemTemplate>    
                                    <asp:TextBox ID="txtCCSFName" runat="server" Text = '<%# Eval("CCSFName") %>'  Width="80px"></asp:TextBox> 
                                   </ItemTemplate>
                                 </asp:TemplateField>
                                 
                                
                                 <asp:TemplateField HeaderText="IAC Code">    
                                   <ItemTemplate>    
                                    <asp:TextBox ID="txtIACCode" runat="server" Text = '<%# Eval("IACCode") %>'  Width="60px"></asp:TextBox> 
                                   </ItemTemplate>
                                 </asp:TemplateField>
                                 
                                  
                                 <asp:TemplateField HeaderText="IAC Name">    
                                   <ItemTemplate>    
                                    <asp:TextBox ID="txtIACName" runat="server" Text = '<%# Eval("IACName") %>'  Width="80px"></asp:TextBox> 
                                   </ItemTemplate>
                                 </asp:TemplateField>
                                 ...
                                 <asp:TemplateField HeaderText="Approval Number">    
                                   <ItemTemplate>    
                                    <asp:TextBox ID="txtApprovalNo" runat="server" Text = '<%# Eval("ApprovalNo") %>'  Width="70px"></asp:TextBox> 
                                   </ItemTemplate>
                                 </asp:TemplateField>
                                 
                                  <asp:TemplateField HeaderText="Street Address">    
                                   <ItemTemplate>    
                                    <asp:TextBox ID="txtStreetAddress" runat="server" Text = '<%# Eval("StreetAddress") %>'  Width="75px"></asp:TextBox> 
                                   </ItemTemplate>
                                 </asp:TemplateField>
                               
                                 <asp:TemplateField HeaderText="City">    
                                   <ItemTemplate>    
                                    <asp:TextBox ID="txtCity" runat="server" Text = '<%# Eval("City") %>'  Width="75px"></asp:TextBox> 
                                   </ItemTemplate>
                                 </asp:TemplateField>
                                 ...
                                 <asp:TemplateField HeaderText="State">    
                                   <ItemTemplate>    
                                    <asp:TextBox ID="txtState" runat="server" Text = '<%# Eval("State") %>'  Width="75px"></asp:TextBox> 
                                   </ItemTemplate>
                                 </asp:TemplateField>
                                 
                                 <asp:TemplateField HeaderText="Country">    
                                   <ItemTemplate>    
                                    <asp:TextBox ID="txtCountry" runat="server" Text = '<%# Eval("Country") %>'  Width="80px"></asp:TextBox> 
                                   </ItemTemplate>
                                 </asp:TemplateField>
                                 
                                 <asp:TemplateField HeaderText="Zip">    
                                   <ItemTemplate>    
                                    <asp:TextBox ID="txtZip" runat="server" Text = '<%# Eval("Zip") %>'  Width="60px"></asp:TextBox> 
                                   </ItemTemplate>
                                 </asp:TemplateField>
                                   ...
                                   <ItemTemplate>    
                                    ...
                                    <asp:TextBox ID="txtExpDate" runat="server" Text = '<%# Eval("ExpirationDt") %>'  MaxLength="15" Width="80px"></asp:TextBox>
