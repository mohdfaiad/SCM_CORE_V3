<%@ Page Title="" Language="C#" MasterPageFile="~/SmartCargoMaster.Master" AutoEventWireup="true" CodeBehind="rptStationWiseInvoiceSummary.aspx.cs" 
    Inherits="ProjectSmartCargoManager.rptStationWiseInvoiceSummary" %>
...
<asp:Label ID="lblStatus" runat="server" BackColor="White" Font-Bold="True" Font-Size="Large"></asp:Label>
 ...
 <h1>Station Wise Invoice Summary</h1>
...
<td class="style1"><asp:Button ID="btnList" runat="server" Text="List" CssClass="button" OnClick="btnList_Click" 
        />
...
<div style="overflow:auto; float:left; width:1024px;"> 
         <asp:GridView ID="grdPPCCSummery" runat="server" Width="80%" >
