<%@ Page Title="" Language="C#" MasterPageFile="~/SmartCargoMaster.Master" AutoEventWireup="true" CodeBehind="rptORNotPrinted.aspx.cs" Inherits="ProjectSmartCargoManager.rptORNotPrinted" %>
...
<asp:ListItem Value="INT">International</asp:ListItem>
                ...
                <td>
                    OR Number</td>
                <td>
                    <asp:TextBox ID="txtORNumber" runat="server"></asp:TextBox>
...
TargetControlID="txtORNumber" OnClientPopulated="onCommListPopulated" FirstRowSelected="true">
