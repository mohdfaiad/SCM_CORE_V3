...
{
    public partial class rptCollectedCRSalesMonth : System.Web.UI.Page
    {
        ...
        protected void btnList_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                ds = da.SelectRecords("Sp_CollectedCreditSales", pname, param, QueryTypes);
                ...
                if (ds != null)
                {
                    if (ds.Tables[0].Rows.Count > 0)
                    {
                        ...
                        Session["dsCreditSales"] = ds.Tables[0];
                        ...
                        ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Reports/rptCreditSales.rdlc");
                        //Customers dsCustomers = GetData("select top 20 * from customers");
                        ReportDataSource datasource = new ReportDataSource("dsCreditSales_dtCreditSales", dtt);
        ...
        private void SaveUserActivityLog(string ErrorLog)
        {
            ...
            objBAL.SaveUserActivityLog(Convert.ToString(Session["IpAddress"]), Session["UserName"].ToString(), "CollectedCreditSalesReport", Convert.ToDateTime(Session["IT"]), Param, ErrorLog, Session["Station"].ToString());
        }
        ...
        protected void btnClear_Click(object sender, EventArgs e)
        {
            try
            {
                Response.Redirect("~/rptCollectCRSalesMonth.aspx");
            }
            catch (Exception ex)
            { }
        }
