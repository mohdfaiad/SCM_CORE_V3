...
{
    public partial class rptStorageChargeReport : System.Web.UI.Page
    {
        ...
        protected void btnList_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                dt1 = DateTime.ParseExact(txtfrmdate.Text, "dd/MM/yyyy", null);
                dt2 = DateTime.ParseExact(txttodate.Text, "dd/MM/yyyy", null); 
                
                object[] param = { ddlStation.SelectedValue, dt1, dt2 };
                string[] pname = { "Station", "FromDate", "ToDate" };
                ...
                ds = da.SelectRecords("SPStorageCharge", pname, param, QueryTypes);
                ...
                if (ds != null)
                {
                    if (ds.Tables[0].Rows.Count > 0)
                    {
                        ...
                        Session["dsStorageCharge"] = ds.Tables[0];
                        ...
                        ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Reports/rptStorageCharge.rdlc");
                        //Customers dsCustomers = GetData("select top 20 * from customers");
                        ReportDataSource datasource = new ReportDataSource("dsStorageCharge_dtStorageCharge", dtt2);
        ...
        private void SaveUserActivityLog(string ErrorLog)
        {
            ...
            objBAL.SaveUserActivityLog(Convert.ToString(Session["IpAddress"]), Session["UserName"].ToString(), "StorageChargeReport", Convert.ToDateTime(Session["IT"]), Param, ErrorLog, Session["Station"].ToString());
        }
        ...
        protected void btnClear_Click(object sender, EventArgs e)
        {
            try
            {
                Response.Redirect("~/rptStorageChargeReport.aspx",false);
            }
            catch (Exception ex)
            { }
        }
