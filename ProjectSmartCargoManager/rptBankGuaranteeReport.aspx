<%@ Page Title="Bank Guarantee Details" Language="C#" MasterPageFile="~/SmartCargoMaster.Master" AutoEventWireup="true" CodeBehind="rptBankGuaranteeReport.aspx.cs" Inherits="ProjectSmartCargoManager.rptBankGuaranteeReport" %>
...
<asp:Label ID="lblStatus" runat="server" BackColor="White" Font-Bold="True" Font-Size="Large"></asp:Label>
    ...
    <dd:webreportviewer ID="RptViewerBankGuarantee" runat="server" Height="500px" 
