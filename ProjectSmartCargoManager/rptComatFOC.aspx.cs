...
{
    public partial class rptComatFOC : System.Web.UI.Page
    {
        ...
        protected void btnList_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                Session["ddsCOMATFOCs"] = null;
                ReportViewer1.Visible = false;
                if (Validate() == false)
                {
                    Session["dsCOMATFOC"] = null;
                    ReportViewer1.Visible = false;
                    return;
                }
                ...
                ds = da.SelectRecords("Sp_COMATFOC", pname, param, QueryTypes);
                ...
                if (ds != null)
                {
                    if (ds.Tables[0].Rows.Count > 0)
                    {
                        ...
                        Session["dsCOMATFOC"] = ds.Tables[0];
                        ...
                        ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Reports/rptComatFOC.rdlc");
                        //Customers dsCustomers = GetData("select top 20 * from customers");
                        ReportDataSource datasource = new ReportDataSource("dsComatFOC_dtComatFOC", dtt2);
        ...
        private void SaveUserActivityLog(string ErrorLog)
        {
            ...
            objBAL.SaveUserActivityLog(Convert.ToString(Session["IpAddress"]), Session["UserName"].ToString(), "Comat/FOCReport", Convert.ToDateTime(Session["IT"]), Param, ErrorLog, Session["Station"].ToString());
        }
        ...
        protected void btnClear_Click(object sender, EventArgs e)
        {
            try
            {
                Response.Redirect("~/rptComatFOC.aspx",false);
            }
            catch (Exception ex)
            { }
        }
