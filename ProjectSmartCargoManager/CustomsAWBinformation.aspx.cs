...
{
    public partial class CustomsAWBinformation : System.Web.UI.Page
    {
        #region Variable
                ...
                if (ds != null)
                {
                    if (ds.Tables != null)
                    {
                        if (ds.Tables.Count > 0)
                        {
                            ...
                            ddlTransidDest.DataSource = ds;
                            ddlTransidDest.DataMember = ds.Tables[0].TableName;
                            ddlTransidDest.DataValueField = ds.Tables[0].Columns["AirportCode"].ColumnName;
                            ddlTransidDest.DataTextField = ds.Tables[0].Columns["AirportCode"].ColumnName;
                            ddlTransidDest.DataBind();
                            ddlTransidDest.Items.Insert(0, new ListItem("Select", "Select"));

                            ddlTransitOrg.DataSource = ds;
                            ddlTransitOrg.DataMember = ds.Tables[0].TableName;
                            ddlTransitOrg.DataValueField = ds.Tables[0].Columns["AirportCode"].ColumnName;
                            ddlTransitOrg.DataTextField = ds.Tables[0].Columns["AirportCode"].ColumnName;
                            ddlTransitOrg.DataBind();
                            ddlTransitOrg.Items.Insert(0, new ListItem("Select", "Select"));
        ...
        protected void btnListAgentStock_Click(object sender, EventArgs e)
        {
            ...
            //2
            Params.SetValue("CustomsAWBMessages", i);
            #endregion Parameters

            DataSet ds = new DataSet();
            ds = objBAL.GetCustomRecords(Params);
            //Session["CustAWBInfoData"] = ds;
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                DateTime frmdt = (DateTime)(ds.Tables[0].Rows[0]["FlightDate"]);
                txtFlightFromdate.Text = frmdt.ToShortDateString();
                ...
                txtTotPcs.Text = ds.Tables[0].Rows[0]["TotalPcs"].ToString();
                txtTotWt.Text = ds.Tables[0].Rows[0]["TotalWt"].ToString(); ;

                txtManifestPc.Text = ds.Tables[0].Rows[0]["ManifestedPcs"].ToString();
                txtManifestWt.Text = ds.Tables[0].Rows[0]["ManifestedWt"].ToString();

                txtRelease.Text = ds.Tables[0].Rows[0]["Released"].ToString();
                txtExam.Text = ds.Tables[0].Rows[0]["Exam"].ToString();
                txtUSCS.Text = ds.Tables[0].Rows[0]["USCS"].ToString();
                txtUSDA.Text = ds.Tables[0].Rows[0]["USDA"].ToString();
                txtOther.Text = ds.Tables[0].Rows[0]["Other"].ToString();

                string transOrg = ds.Tables[0].Rows[0]["TransitOrigin"].ToString();
                ddlTransitOrg.SelectedIndex = ddlTransitOrg.Items.IndexOf(((ListItem)ddlTransitOrg.Items.FindByText(transOrg)));

                string transDest = ds.Tables[0].Rows[0]["TransitDest"].ToString();
                ddlTransidDest.SelectedIndex = ddlTransidDest.Items.IndexOf(((ListItem)ddlTransidDest.Items.FindByText(transDest)));
            ...
            grdCustInfoList.DataSource = ds;
            grdCustInfoList.DataBind();
        }
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            //22
            Params.SetValue(txtTotPcs.Text, i);
            i++;

            //23
            Params.SetValue(txtTotWt.Text, i);
            i++;

            //24
            Params.SetValue(txtManifestPc.Text, i);
            i++;

            //25
            Params.SetValue(txtManifestWt.Text, i);
            i++;

            //26
            Params.SetValue(txtRelease.Text, i);
            i++;

            //27
            Params.SetValue(txtExam.Text, i);
            i++;

            //28
            Params.SetValue(txtUSCS.Text, i);
            i++;

            //29
            Params.SetValue(txtUSDA.Text, i);
            i++;

            //30
            Params.SetValue(txtOther.Text, i);
            i++;

            //31 ddlTransitOrg.SelectedItem.Text
            Params.SetValue(ddlTransitOrg.SelectedItem.Text, i);
            i++;

            //32 ddlTransidDest.SelectedItem.Text
            Params.SetValue(ddlTransidDest.SelectedItem.Text, i);
            i++;
            ...
            //35 ddlTransCtrl.SelectedItem.Text
            Params.SetValue(txtTransCtrl.Text, i);
            i++;

            //36 ddlOnwardCarr.SelectedItem.Text
            ...
            #endregion Parameters
            bool result = objBAL.SaveCustomsAWBMessages(Params);
            if (result == true)
            {
