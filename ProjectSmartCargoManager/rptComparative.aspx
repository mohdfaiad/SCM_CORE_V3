<%@ Page Title="" Language="C#" MasterPageFile="~/SmartCargoMaster.Master" AutoEventWireup="true" CodeBehind="rptComparative.aspx.cs" Inherits="ProjectSmartCargoManager.rptComparative" %>
...
<td class="style1">
<asp:RadioButtonList ID="rdbweekmonth" runat="server" RepeatDirection="Horizontal">
<asp:ListItem Text="Weekly" Selected="True" Value="W"></asp:ListItem>
...
<td class="style1">
    ...
    <asp:CalendarExtender ID="CalendarExtender1" runat="server" TargetControlID="txtFromDate" Format="dd/MM/yyyy" Enabled="true" PopupButtonID="imgFromDate1"></asp:CalendarExtender>
                    <asp:ImageButton ID="imgFromDate1" runat="server" ImageAlign="AbsMiddle" 
