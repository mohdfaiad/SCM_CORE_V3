<%@ Page Title="" Language="C#" MasterPageFile="~/SmartCargoMaster.Master" AutoEventWireup="true"
    CodeBehind="rptORTransation.aspx.cs" Inherits="ProjectSmartCargoManager.rptORTransaction" %>
            ...
            <table>
                <tr>
                    ...
                    <td class="style1">
                        ...
                        <asp:CalendarExtender ID="C1" runat="server" TargetControlID="txtfrmdate" Format="dd/MM/yyyy"
                            Enabled="true" PopupButtonID="imgFromDate">
                    ...
                    <td class="style1">
                        ...
                        <asp:CalendarExtender ID="CalendarExtender1" runat="server" TargetControlID="txttodate"
                            Format="dd/MM/yyyy" Enabled="true" PopupButtonID="imgToDate">
                        </asp:CalendarExtender>
                ...
                <tr>
                    ...
                    <td class="style1">
                        <asp:CalendarExtender ID="CalendarExtender2" runat="server" TargetControlID="txtfrmdate"
                            Format="dd/MM/yyyy" Enabled="true" PopupButtonID="imgFromDate">
                        </asp:CalendarExtender>
                    ...
                    <td class="style1">
                        ...
                        <asp:DropDownList ID="ddlFOP" runat="server">
                    ...
                    <td class="style1">
                        ...
                        <asp:Button ID="btnExport" runat="server" CssClass="button" Visible="false" Text="Export"
