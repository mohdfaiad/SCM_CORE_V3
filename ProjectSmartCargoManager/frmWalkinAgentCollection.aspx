<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmWalkinAgentCollection.aspx.cs" Inherits="ProjectSmartCargoManager.frmWalkinAgentCollection" MasterPageFile="~/SmartCargoMaster.Master" %>
  ...
  <table width="100%" cellpadding="3">
    ...
    <tr>
        <td>
            ...
            <asp:Button ID="btnHandover" runat="server" Text="Handover" CssClass="button" 
        onclick="btnHandover_Click" />
    &nbsp;
...
<div>
<%--onrowdatabound="grdInvoiceList_RowDataBound" onpageindexchanging="grdInvoiceList_PageIndexChanging"--%>
<asp:GridView ID="grdHandoverAmount" Width="80%" runat="server"
