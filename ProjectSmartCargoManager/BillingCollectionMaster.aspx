<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BillingCollectionMaster.aspx.cs" MasterPageFile="~/SmartCargoMaster.Master" Inherits="ProjectSmartCargoManager.BillingCollectionMaster" %>
 ...
 <asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
       ...
       // function CreditCardPopup() {
            //Show popup for accepting Credit Card
//            window.open('creditcard.aspx', 'Credit Payment',
//            'left=400,top=200,width=500,height=250,toolbar=0,resizable=no');
            //            return false;
...
<br/>
<div id="divPrint" class="ltfloat" style="width:1024px; overflow:auto;">
 ...
 <AlternatingRowStyle CssClass="trcolor">
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Agent Name" ItemStyle-HorizontalAlign="Center" HeaderStyle-Wrap="true" Visible=false>
                 ...
                 <asp:TemplateField HeaderText="Agent Name" ItemStyle-HorizontalAlign="Left" HeaderStyle-Wrap="true">
                    <ItemTemplate>
                ...
                <asp:TemplateField HeaderText="194C" ItemStyle-HorizontalAlign="Center" HeaderStyle-Wrap="true">
                    <ItemTemplate>
              ...
              <%--   <asp:TemplateField HeaderText="ORNumber" ItemStyle-HorizontalAlign="Center" HeaderStyle-Wrap="true">
                    <ItemTemplate>
                       <asp:LinkButton ID="lblORNumber" runat="server" Text='<%# Eval("ORRecieptNo") %>' CommandName="ORNumber" CommandArgument='<%# Eval("ORRecieptNo") %>' ></asp:LinkButton>
                    </ItemTemplate>
                    <HeaderStyle Wrap="True"></HeaderStyle>
                    <ItemStyle Wrap="False" />
                </asp:TemplateField>
...
<br />
<asp:Panel runat="server" ID="pnlAddCollection" GroupingText = "Collection" Visible="false" class="ltfloat" style="width:100%;">
<div id = "divcol">
  <table width=" 95%">
   <tr>
    <td>
...
<asp:Panel runat="server" ID="pnlDCMAdjustment" GroupingText = "DCM Adjustment" Visible="false" class="ltfloat" style="width:100%;">
<div>
  <table width=" 95%">
   <tr>
    <td>
