<%@ Page Title="" Language="C#" MasterPageFile="~/SmartCargoMaster.Master" AutoEventWireup="true" CodeBehind="rptWareImpDisposal.aspx.cs" Inherits="ProjectSmartCargoManager.rptWareImpDisposal" %>
...
Goods Type:
    ...
    <td valign="top">PER-<asp:TextBox ID="txtPER" runat="server" Width="30px"></asp:TextBox></td>
    <td valign="top">AVI-<asp:TextBox ID="txtAVI" runat="server" Width="30px"></asp:TextBox></td>
    <td valign="top">VAL-<asp:TextBox ID="txtVAL" runat="server" Width="30px"></asp:TextBox></td>
    <td valign="top">Other-<asp:TextBox ID="txtOther" runat="server" Width="30px"></asp:TextBox></td>
