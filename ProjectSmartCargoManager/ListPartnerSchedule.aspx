<%@ Page Title="" Language="C#" MasterPageFile="~/SmartCargoMaster.Master" AutoEventWireup="true" CodeBehind="ListPartnerSchedule.aspx.cs" Inherits="ProjectSmartCargoManager.ListPartnerSchedule" %>
     ...
     <div id="contentarea">
        <h1>
            ...
            <table width="100%">
                <tr>
                    <td>
                        Partner Type</td>
                    <td>
                        <asp:DropDownList ID="drpPartnerType" runat="server" Width="100px" 
                            onselectedindexchanged="drpPartnerType_SelectedIndexChanged" AutoPostBack="true">
                        </asp:DropDownList>
                    </td>
                    <td >
                        Partner Name</td>
                    <td colspan="3">
                        <asp:DropDownList ID="ddlPartnerCode" runat="server" Width="97%"></asp:DropDownList>
                ...
                <tr>
                    ...
                    <asp:AutoCompleteExtender ID="AutoCompleteExtendertxtFlightNo1" runat="server" 
                        EnableCaching="true" Enabled="True" MinimumPrefixLength="2" 
                        ServiceMethod="GetFlightId" ServicePath="~/ListAirlineSchedule.aspx" 
                        TargetControlID="txtFlightNo">
                    </asp:AutoCompleteExtender>
                    <td>
                        AirCraftType</td>
                    <td>
                    ...
                    <td>
                        <asp:DropDownList ID="ddlOrigin" runat="server" AutoPostBack="True" 
                            onselectedindexchanged="ddlOrigin_SelectedIndexChanged" Visible="False">
                        </asp:DropDownList>
                    </td>
                    <td>
                        &nbsp;</td>
              ...
              <asp:ImageButton ID="imgToDate" runat="server" ImageAlign="AbsMiddle" ImageUrl="~/Images/calendar_2.png" />
                    ...
                    <td >
                        &nbsp;</td>
                    <td>
                        <asp:CheckBox ID="chkDomestic" runat="server"
         ...
         <asp:Label ID="lblStatus" runat="server" BackColor="White" Font-Bold="True" 
            ...
            AutoGenerateColumns="False" PageSize="10" AllowPaging="True" onrowcommand="grdFlight_RowCommand" 
                onselectedindexchanging="grdFlight_SelectedIndexChanging" onpageindexchanging="grdFlight_PageIndexChanging" 
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="SrNo" Visible = "false" HeaderStyle-Wrap="true">
                 ...
                 <asp:TemplateField HeaderText="Flight#" HeaderStyle-Wrap="true">
                    <ItemTemplate>
                       <asp:LinkButton ID="lblFlightID" runat="server" Width="50px" CommandName="Flight" ></asp:LinkButton > <%--Text='<%# Eval("FlightID") %>'--%>
                    </ItemTemplate>
                    <HeaderStyle Wrap="True"></HeaderStyle>
    ...
    <asp:TemplateField HeaderText="From Date" HeaderStyle-Wrap="false"  Visible="true">
     ...
     TargetButtonUpID=""   Minimum = "1"  Maximum = "60" /> 
               ...
               <asp:TemplateField HeaderStyle-Wrap="false" HeaderText="Tail No" ItemStyle-Width="30%">
                     <ItemTemplate>
                            <asp:DropDownList ID="ddlTailNo" runat="server"></asp:DropDownList>
                      </ItemTemplate>
                  <FooterStyle HorizontalAlign="Right" />
