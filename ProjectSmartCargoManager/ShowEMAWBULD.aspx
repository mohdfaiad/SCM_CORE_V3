<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShowEMAWBULD.aspx.cs" Inherits="ProjectSmartCargoManager.ShowEMAWBULD" %>
...
<body>
    ...
    <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
        ...
        <LocalReport ReportPath="Reports\EXP_ULDMAWB.rdlc">
            <DataSources>
                <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" 
                    Name="EMULDAWB_dtManifest" />
                <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" 
                    Name="EMULDAWB_dtTransitAWB" />
            </DataSources>
        </LocalReport>
    </rsweb:ReportViewer>
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
        SelectMethod="GetData" 
        TypeName="ProjectSmartCargoManager.EMULDAWBTableAdapters.">
