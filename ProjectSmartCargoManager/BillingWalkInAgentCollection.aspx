<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BillingWalkInAgentCollection.aspx.cs" MasterPageFile="~/SmartCargoMaster.Master" Inherits="ProjectSmartCargoManager.BillingWalkInAgentCollection" %>
...
<tr>
<td>
<asp:Label ID="lblOpngBal" runat ="server" Text="Balance to be posted:" />
</td>
<td>
  ...
  <div id="fotbut">
            <table>
                <tr>
                    ...
                    <td>
                        <asp:Button ID="btnPosttoTreasury" Visible="false" runat="server" 
                            Text="Post To Treasury" CssClass="button" 
                            onclick="btnPosttoTreasury_Click" />
                    </td>
                    <td>
                        <asp:Button ID="btnExit" runat="server" Text="Exit" CssClass="button" OnClientClick="javascript:ClosePopUp(); return false;" />
                    </td>
                    <td><asp:HiddenField ID="HdnSelectedRowIndex" runat="server" Value="" /></td>
                    <td><asp:HiddenField ID="HdnBooking" runat="server" Value="" /></td>
                </tr>
            </table>
            </div>
            <br />
