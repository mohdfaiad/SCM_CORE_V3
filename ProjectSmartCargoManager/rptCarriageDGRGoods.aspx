<%@ Page Title="" Language="C#" MasterPageFile="~/SmartCargoMaster.Master" AutoEventWireup="true" CodeBehind="rptCarriageDGRGoods.aspx.cs" Inherits="ProjectSmartCargoManager.rptCarriageDGRGoods" %>
...
<asp:Label ID="lblStatus" runat="server" BackColor="White" Font-Bold="True" Font-Size="Large"></asp:Label>
     ...
     <asp:ToolkitScriptManager ID="ScriptManager1" runat="server">
            ...
            <h1>
            Carriage Of Dangerous Goods</h1>
    <div class="botline">
