...
{
    public partial class ListMulipleSelectTransitStation : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!IsPostBack)
                {
                    ddlds1 = da.SelectRecords("SP_GetAirportCodeList");
                    if (ddlds1.Tables.Count > 0)
                    {
                        ...
                        GRD.Columns[1].HeaderText = "AirportCode";
                    }
