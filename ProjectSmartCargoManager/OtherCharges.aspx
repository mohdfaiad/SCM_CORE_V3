<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OtherCharges.aspx.cs" MasterPageFile="~/SmartCargoMaster.Master"
    Inherits="ProjectSmartCargoManager.OtherCharges" %>
...
//            var TxtClientValue = document.getElementById('ctl00_ContentPlaceHolder1_TXTHandlingCode').value;
        ...
        function GetCode() {
            ...
            var TxtCurrencyClientObject = '<%= TXTChargeHeadCode.ClientID %>';
            ...
            <table style="width: 90%; height: 20px">
                <tr>
                    ...
                    <td align="left" style="width: 170px">
                        <asp:TextBox ID="TXTChargeHeadCode" runat="server" Width="120px" onchange="return GetOCHeadCode(this);"></asp:TextBox>
                                    <asp:AutoCompleteExtender ID="ACEOCCode" BehaviorID="ACEOCCode" runat="server"
                                                        ServiceMethod="GetIATAOCCodes" CompletionInterval="0" EnableCaching="false"
                                                        CompletionSetCount="10" TargetControlID="TXTChargeHeadCode" MinimumPrefixLength="1"
                                                        OnClientPopulated="onOCCodePopulated">
                                                    </asp:AutoCompleteExtender>
                      <%--  <asp:ImageButton ID="ImageButton2" runat="server" ImageUrl="~/Images/list_bullets.png"
                            ImageAlign="AbsMiddle" OnClientClick="javascript:GetCode();return false;" />--%>
        ...
        <asp:Label ID="lblStatus" runat="server" ForeColor="Red"></asp:Label>
            ...
            <table width="100%">
                ...
                <tr>
                    ...
                    <td colspan="3">
                        <asp:TextBox ID="TXTChargeHeadName" runat="server" Width="220px"> </asp:TextBox>
                    </td>
                    <td>OC Code*</td>
                    <td>
                        <asp:DropDownList ID="ddlOCCode" runat="server" Width="130px">
                        </asp:DropDownList>
                    </td>
                    <td>Status</td>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="DDLParticipationType" runat="server" Width="90px">
                    ...
                    <td>
                    <asp:DropDownList ID="DDLCharge" runat="server" Width="90px">
                        <%-- <asp:ListItem Text="Normal" Value="N"></asp:ListItem>
                          <asp:ListItem Text="CUT" Value="C"></asp:ListItem>
                           <asp:ListItem Text="AAI" Value="A"></asp:ListItem>--%>
                        </asp:DropDownList>
                        <asp:CheckBox ID="CHKRefundable" runat="server" Text="" Visible="false"/>
                    </td>
                    <td>
                        Start Date
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="TXTDiscount" runat="server" Width="60px" CssClass="alignrgt"></asp:TextBox>%
                    </td>
                    <td>
                        Commision
                    </td>
                    <td>
                        <asp:TextBox ID="TXTCommision" runat="server" Width="60px" CssClass="alignrgt"></asp:TextBox>%
                    </td>
                    <td>
                        Tax
                    </td>
                    <td>
                        <asp:TextBox ID="TXTTax" runat="server" Width="60px" CssClass="alignrgt"></asp:TextBox>%
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <asp:CheckBox ID="chkIgnoreCCSF" runat="server" Text="Ignore CCSF" /></td>
                    <td>
                        <asp:CheckBox ID="chkIsPackaging" runat="server" Text="Packaging Charge" /></td>
                    <td>
                        &nbsp;</td>
                    <td>
                        &nbsp;</td>
            ...
            <td valign="top" style="width:30%;">
                <br />
                                        ...
                                        <td class="style2">
                                            ...
                                            <caption>
                                                <tr ID="trMinimum">
                                                    ...
                                                    <td>
                                                        <asp:DropDownList ID="DDLHeadBasis" runat="server" AppendDataBoundItems="true" 
                                                            ...
                                                            <asp:ListItem Value="L">SLAC Base</asp:ListItem>
                                                        </asp:DropDownList></td>
                                                </tr>
                                                <tr ID="trMinimum">
                                                    <td class="style2">
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="TXTMinimum" runat="server" Enabled="false" ToolTip="Price"
                    ...
                    runat="server" WatermarkText="Price" Enabled="True" TargetControlID="TXTMinimum">
                                                         ...
                                                         /
                                                         <asp:TextBox ID="TXTMCost" runat="server" Enabled="false" ToolTip="Cost"
                                                            Width="60px" CssClass="alignrgt"></asp:TextBox>
                    ...
                    runat="server" WatermarkText="Cost" Enabled="True" TargetControlID="TXTMCost">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="TXTCharge" runat="server" Width="60px" CssClass="alignrgt" ToolTip="Price"></asp:TextBox>
                                                        ...
                                                        /<asp:TextBox ID="TXTCost" runat="server" Width="60px" CssClass="alignrgt" ToolTip="Cost"></asp:TextBox>
                    ...
                    runat="server" WatermarkText="Cost" Enabled="True" TargetControlID="TXTCost">
                                                        ...
                                                        <asp:DropDownList ID="DDLWtType" runat="server" Enabled="false" 
                                                ...
                                                <tr>
                                                    <td>Maximum</td>
                                                    <td>
                                                        <asp:TextBox ID="txtMaxValue" CssClass="alignrgt" runat="server" Width="60px"></asp:TextBox>
                                                         <asp:TextBoxWatermarkExtender ID="Watermark_txtMaxValue" 
                                                         runat="server" WatermarkText="Price" Enabled="True" TargetControlID="txtMaxValue"/>
                                                         <asp:FilteredTextBoxExtender ID="Filter_txtMaxValue" runat="server" Enabled="True" FilterType="Numbers" TargetControlID="txtMaxValue" ValidChars="0123456789"></asp:FilteredTextBoxExtender>
                                                        /
                                                        <asp:TextBox ID="txtMaxCost" CssClass="alignrgt" runat="server" Width="60px"></asp:TextBox>
                                                        <asp:TextBoxWatermarkExtender ID="Watermark_txtMaxCost" 
                                                         runat="server" WatermarkText="Cost" Enabled="True" TargetControlID="txtMaxCost"/>
                                                         <asp:FilteredTextBoxExtender ID="Filter_txtMaxCost" runat="server" Enabled="True" FilterType="Numbers" TargetControlID="txtMaxCost" ValidChars="0123456789"></asp:FilteredTextBoxExtender>
                                                    </td>
                                                </tr>
                                                <tr>
                                                <td class="style2">
                                                Applied On</td>
                                                 <td>
                                                        <asp:DropDownList ID="ddlBasedOn" runat="server" Enabled="false">
                                                            <asp:ListItem Text="Freight" Value="F"></asp:ListItem>
                                                            <asp:ListItem Text="Declared Value" Value="D"></asp:ListItem>                                                            
                                                        </asp:DropDownList>
                                                        BaseRate
                                                        <asp:TextBox ID="TXTBaseRate" runat="server" Text="0" Width="60px" Enabled="false" CssClass="alignrgt"></asp:TextBox>
                                                ...
                                                <tr>
                                                    <td class="style2">
                                                        ChargedAt</td>
                                                    <td>
                                                        <asp:DropDownList ID="ddlType" runat="server" Enabled="true">
                                                ...
                                                <tr>
                                                    <td class="style2">
                                                        Via Station</td>
                                                    <td>
                                                        <asp:DropDownList ID="ddlViaStation" runat="server" Enabled="true">
                                                        </asp:DropDownList>
                                                    </td>
                                                </tr>
                                                <tr>
                        ...
                        <div class="divback" id="divSlab">
                                    <table style="width:100%;">
                                        <tr>
                                            <td align="right">
                                                ...
                                                <asp:Button ID="Button1" runat="server" Text="Add" CssClass="button" OnClick="LBNAdd_OnClick" />
                                                &nbsp;
                                ...
                                <div class="divback" id="divMap" runat="server" >
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderStyle-Wrap="true" HeaderText="Type" Visible="false">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderStyle-Wrap="false" HeaderText="Weight" Visible="false">
                                            <ItemTemplate>
                ...
                <td  valign="top">
                    <div class="divback">
                        <asp:TabContainer ID="TabContainer" runat="server" ActiveTabIndex="0" 
                            ...
                            <asp:TabPanel ID="TBPExceptions" runat="server" HeaderText="TabPanel2">
                                <HeaderTemplate>
                             ...
                             <asp:TabPanel ID="TBTrigger" runat="server" HeaderText="TabPanel2">
                                <HeaderTemplate>
...
<FooterTemplate>
        ...
        <table width="100%">
            ...
            <tr>
                <td align="justify">
                    &nbsp;<asp:Button ID="btnAddAnother" runat="server" CssClass="button" 
                        onclick="btnAddAnother_Click" Text="Add Another" />
