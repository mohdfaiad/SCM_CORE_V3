...
{
	public partial class rptAWBSummarisedBilling : System.Web.UI.Page
	{
        #region Variable
        ...
        protected void btnList_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                try
                {
                    ...
                    DataSet res_Revenue = objReport.GetAWBBilligSummary(AgentCode, PaymentType, contrLocatorCode, level, levelCode, frmDate, ToDt);
                    ...
                    if (res_Revenue != null)
                    {
                        if (res_Revenue.Tables[0].Rows.Count > 0)
                        {
                            ...
                            info = new FileInfo(Server.MapPath("/Reports/rptMISBillingSummary.rdlx"));
                            //info = new FileInfo(System.Configuration.ConfigurationManager.AppSettings["ReportPath"] + "rptMISBillingSummary.rdlx");
