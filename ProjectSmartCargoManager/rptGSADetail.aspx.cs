...
{
    public partial class rptGSADetail : System.Web.UI.Page
    {
        ...
        protected void btnList_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                object[] param = { fromdate, todate, txtGSACode.Text.Trim(), ddlStationType.Text.Trim() };
                string[] pname = { "fromdate", "todate", "GSACode", "StationType" };
                SqlDbType[] QueryTypes = { SqlDbType.VarChar, SqlDbType.VarChar, SqlDbType.VarChar, SqlDbType.VarChar };



                ds = da.SelectRecords("spGSADetailReport", pname, param, QueryTypes);
                ...
                if (ds != null)
                {
                    if (ds.Tables[0].Rows.Count > 0)
                    {
                        ...
                        //Session["rptGSADetail"] = ds.Tables[0];
                        ...
                        ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Reports/rptGSAIntReport.rdlc");
                        ReportDataSource datasource = new ReportDataSource("dsrptGSADetail_dtrptGSADetail1", dt);
        ...
        private void SaveUserActivityLog(string ErrorLog)
        {
            ...
            objBAL.SaveUserActivityLog(Convert.ToString(Session["IpAddress"]), Session["UserName"].ToString(), "GSA Production Report", Convert.ToDateTime(Session["IT"]), Param, ErrorLog, Session["Station"].ToString());
        }
        protected void btnClear_Click(object sender, EventArgs e)
        {
            Response.Redirect("~/rptGSADetail.aspx", false);
        }
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if ((DataSet)Session["rptGSADetail"] == null)
                    GetData();

                dt = ((DataSet)Session["rptGSADetail"]).Tables[0];
              

                if (Session["rptGSADetail"] == null && dt == null)
                {
                    lblStatus.Text = "No records found";
                    lblStatus.ForeColor = Color.Red;
                ...
                Session["rptGSADetail"] = null;
                string attachment = "attachment; filename=GSADetailReport.xls";
