<%@ Page Title="" Language="C#" MasterPageFile="~/SmartCargoMaster.Master" AutoEventWireup="true" CodeBehind="GHAHome.aspx.cs" Inherits="ProjectSmartCargoManager.GHAHome" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
   ...
   <asp:TextBox ID="Country" runat="server"></asp:TextBox>
    ...
    </asp:AutoCompleteExtender>--%><style type="text/css">
        .style1
        {
            width: 30%;
        }
...
<div id="contentarea">
    ...
    <asp:Timer ID="Timer1" runat="server"  Interval="600000" ontick="Timer1_Tick" Enabled = "true">
    </asp:Timer>
...
<td>      
 <a href="AirportMaster.aspx"> 
    <img style="margin: 0px 20px; border-bottom: 0px; border-left: 0px; border-top: 0px; border-right: 0px;" 
        src="Images/warehousecontact.png" complete="complete"/></a>
         <a 
        href="GHA_DriverDetails.aspx"  >
        <img style="margin: 1px 20px; border:0px;" 
        src="Images/txt_acceptcargo.png" complete="complete"/></a>
        
        <a 
        href="frmAWBTrackingMaster.aspx"><img style="margin: 1px 33px 0px 20px; border: 0px;" 
        src="Images/txt_trackingnew.png" complete="complete"/></a>
        <a 
        href="UserCreation.aspx">
        <img style="margin: 1px 20px; border:0px;" 
        src="Images/txt_administration.png" complete="complete"/></a><%--<a href="#"> <img style="margin:0 20px;" src="Images/txt_cargorate.png" /> </a>   --%><%--<a href="ListAirlineSchedule.aspx"> <img style="margin:0 20px;" src="Images/txt_flightdetails.png" />  </a> --%></td>       
  <td>          
...
<tr>     
 <td valign="top" style="width:30%">         
  <img src="Images/txt_notification.png" /><br />       
...
<br />
 <div style="margin:10px; padding:10px; border:1px solid red;">Today:</div>--%><asp:Panel 
          ID="PanelGraph" runat="server">
      <table width="100%">
      <tr>
      <td>
      <asp:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="0" Font-Size="Medium" 
            ...
            <%--OnActiveTabChanged="GetData_Click"--%><%--OnClientActiveTabChanged="CallPopulateClick();"--%><asp:TabPanel ID="TabPanel1" runat="server" HeaderText="Flights" Width="620px"
...
&nbsp;</HeaderTemplate>
    ...
    <td>
        <asp:Button ID="GetData" runat="server" Text="Populate Data" class = "button" 
      ...
      <asp:TabPanel ID="TabPanel2" runat="server" HeaderText="Export" Width="620px"
                Height="27px">
                <HeaderTemplate>
                    &nbsp; Export
&nbsp; </HeaderTemplate>
...
&nbsp; </HeaderTemplate>
      ...
      <asp:GridView ID="grdImportList" runat="server" ShowFooter="false" Width="80%" 
         ...
         OnPageIndexChanging="grdImportList_PageIndexChanging">
           ...
           <asp:TabPanel ID="TabPanel4" runat="server" HeaderText="Dock" Width="620px"
                Height="27px">
                <HeaderTemplate>
                    &nbsp; Dock
&nbsp; </HeaderTemplate>
      ...
      <asp:GridView ID="grdDock" runat="server" ShowFooter="false" Width="80%" 
            AutoGenerateColumns="False" BorderColor="#BFBEBE" BorderStyle="None" 
            CellPadding="2" CellSpacing="3" PageSize="10" AllowPaging="True">
  ...
  <%------------------------------Sumit--------------------------------------%><div id = "divLabels" style="width:0%;background-color:White" runat = "server" >
