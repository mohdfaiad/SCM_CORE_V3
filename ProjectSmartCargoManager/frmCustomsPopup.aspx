<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmCustomsPopup.aspx.cs" Inherits="ProjectSmartCargoManager.frmCustomsPopup" %>
 ...
 /* fallback */
  ...
  background: -o-linear-gradient(top, #cacaca, #8f9091);
    ...
    <div id="contentarea" style="margin-top:0px;">
       <asp:Label ID="lblStatus" runat="server" BackColor="White" Font-Bold="True" Font-Size="Medium"
             ForeColor="Red"></asp:Label>
    <div style="display:none;">
     <table width="100%">
     <tr>
     <td><asp:Label ID="Label9" runat="server" Height="16px" Text="Flight #"></asp:Label> </td>
     <td>
       <%--<asp:DropDownList ID="ddlFightDesignator" runat="server">
            </asp:DropDownList>--%>
            <asp:TextBox ID="ddlFightDesignator" runat="server" MaxLength="2" Width="40px"></asp:TextBox>
            
                    <asp:TextBox ID="txtFlightID" runat="server" Width="44px" ></asp:TextBox></td>
                    <td><asp:Label ID="Label1" runat="server" Height="16px" Text="Flight Date"></asp:Label></td>
                    <td>
     ...
     <asp:GridView ID="GRDBooking" runat="server" AllowPaging="true" 
      ...
      <asp:Button ID="btnAudit" runat="server" CssClass="button" Text="Customs Audit" 
             ...
             onrowcommand="grdMessages_RowCommand" >
                            ...
                            <ItemTemplate>
                            <asp:HyperLink  ID="lnkAWBNumber" runat="server" Text='<%# Eval("AWBNo") %>' NavigateUrl='<%# "GHA_ConBooking.aspx?command=Edit&AWBNumber=" + Eval("AWBNumber")%>'></asp:HyperLink>
                            </ItemTemplate>
                            </asp:TemplateField>
...
--%>
        ...
        <tr>
        <td><asp:Label ID="lblRemarks" runat="server" Height="16px" Text="Remarks"></asp:Label></td>
            ...
            <tr>
                <td>
                   <asp:TextBox ID="txtMessagePreview" runat="server" TextMode="MultiLine" 
                        Height="250px" Width="390px"  ></asp:TextBox>
                </td>
            </tr>
        </table>
