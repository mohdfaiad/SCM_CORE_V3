...
{
    public partial class rptOverpayment : System.Web.UI.Page
    {
        ...
        protected void btnList_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                ds = da.SelectRecords("Sp_Overpayment", pname, param, QueryTypes);
                ...
                if (ds != null)
                {
                    if (ds.Tables[0].Rows.Count > 0)
                    {
                        ...
                        Session["Overpayment"] = ds.Tables[0];
                        ...
                        ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Reports/rptOverpayment.rdlc");
                        //Customers dsCustomers = GetData("select top 20 * from customers");
                        ReportDataSource datasource = new ReportDataSource("dsOverpayment_dtOverpayment", dtt2);
        ...
        private void SaveUserActivityLog(string ErrorLog)
        {
            ...
            objBAL.SaveUserActivityLog(Convert.ToString(Session["IpAddress"]), Session["UserName"].ToString(), "OverpaymentReport", Convert.ToDateTime(Session["IT"]), Param, ErrorLog, Session["Station"].ToString());
        }
        ...
        protected void btnClear_Click(object sender, EventArgs e)
        {
            try
            {
                Response.Redirect("~/rptOverpayment.aspx",false);
            }
            catch (Exception ex)
            { }
        }
