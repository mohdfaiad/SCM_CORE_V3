...
{
    public partial class rptAWBSummarisedBooking : System.Web.UI.Page
    {
        #region Variable
                ...
                try
                {
                    ...
                    if (res_Revenue != null)
                    {
                        if (res_Revenue.Tables[0].Rows.Count > 0)
                        {
                            ...
                            info = new FileInfo(Server.MapPath("/Reports/rptMISBookingSummary.rdlx"));
                           // info = new FileInfo(System.Configuration.ConfigurationManager.AppSettings["ReportPath"] + "rptMISBookingSummary.rdlx");
