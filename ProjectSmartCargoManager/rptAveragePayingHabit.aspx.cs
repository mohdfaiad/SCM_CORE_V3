...
{
    public partial class rptAveragePayingHabit : System.Web.UI.Page
    {
        ...
        protected void btnList_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                Session["rptAveragePayingHabit"] = null;
                ReportViewer1.Visible = false;
                ...
                object[] param = { fromdate, todate, ddlStation.SelectedItem.Value.ToString(), ddlStationType.SelectedItem.Value.ToString(), ddlAgent.SelectedItem.Value.Trim() };
                string[] pname = { "fromdate", "todate", "Station", "StationType", "Agent" };
                SqlDbType[] QueryTypes = { SqlDbType.VarChar, SqlDbType.VarChar, SqlDbType.VarChar, SqlDbType.VarChar, SqlDbType.VarChar };



                ds = da.SelectRecords("spAveragePayingHabit", pname, param, QueryTypes);
                ...
                if (ds != null)
                {
                    if (ds.Tables[0].Rows.Count > 0)
                    {
                        ...
                        Session["rptAveragePayingHabit"] = ds.Tables[0];
                        //Logo
                        try
                        {
                        ...
                        ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Reports/rptAveragePayingHabit.rdlc");
                        ReportDataSource datasource = new ReportDataSource("dsrptAveragePayingHabit_DataTable1", dt);
        ...
        private void SaveUserActivityLog(string ErrorLog)
        {
            ...
            objBAL.SaveUserActivityLog(Convert.ToString(Session["IpAddress"]), Session["UserName"].ToString(), "Average Paying Habit Report", Convert.ToDateTime(Session["IT"]), Param, ErrorLog, Session["Station"].ToString());
        }
        protected void btnClear_Click(object sender, EventArgs e)
        {
            Response.Redirect("~/rptAveragePayingHabit.aspx");
        }
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if ((DataTable)Session["rptAveragePayingHabit"] == null)
                    GetData();

                dt = (DataTable)Session["rptAveragePayingHabit"];

                if (Session["rptAveragePayingHabit"] == null && dt == null)
                {
                    lblStatus.Text = "No records found";
                    lblStatus.ForeColor = Color.Red;
                ...
                string attachment = "attachment; filename=AveragePayingHabitReport.xls";
        ...
        {
            DataSet ds = da.SelectRecords("spGetAgentCodes");
