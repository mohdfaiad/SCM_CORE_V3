...
{
    public partial class ListMultipleSpecialHandlingCode : System.Web.UI.Page
    {
        ListDataViewBAL objBAL = new ListDataViewBAL();
        SQLServer da = new SQLServer(Global.GetConnectionString());
        string errormessage = "";
        DataSet dsResult = new DataSet("ListMultipleSpecialHandlingCode_1");
        DataSet ddlds1 = new DataSet("ListMultipleSpecialHandlingCode_2");
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (!IsPostBack)
                {
                    ddlds1 = da.SelectRecords("SP_GetSpecialHandlingCode");
                    ...
                    GRD.DataBind();
                        ...
                        GRD.Columns[1].HeaderText = "SpecialHandlingCode";
                    }
