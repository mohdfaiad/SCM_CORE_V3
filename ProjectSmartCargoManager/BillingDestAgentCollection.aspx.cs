...
{
    public partial class BillingDestAgentCollection : System.Web.UI.Page
    {
        ...
        protected void bindCollectionDetails()
        {
            try
            {
                ...
                DataSet DSInvoicedata = objBAL.GetCollectionDestMasterData(ddlAgentName.SelectedValue, ddlBillType.SelectedValue, txtOrigin.Text, Convert.ToDateTime(strfromdate).ToString("yyyy-MM-dd HH:mm:ss"), Convert.ToDateTime(strtodate).AddDays(1).ToString("yyyy-MM-dd HH:mm:ss"), txtInvoiceNumber.Text.Trim(), txtAWBPrefix.Text.Trim() + txtAWBNumber.Text.Trim(),"All");
        ...
        protected void btnEdit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //if (txtChequeDate.Text != null)
                //{
                //    strdate = txtChequeDate.Text;
                //}
                #region Prepare Parameters
            ...
            try
            {
                if (e.CommandName == "Detail")
                {
                    ...
                    try
                    {
                        ...
                        DataSet ds = db.SelectRecords("SP_GetDestInvoiceDataInvMatch", "InvoiceNumber", InvoiceNumber, SqlDbType.VarChar);
                        if (InvoiceNumber != "")
                        {
                            if (ds != null)
                            {
                ...
                try
                {
                    if (e.CommandName == "ORNumber")
                    {
                        ...
                        DataSet ds = BALCol.GetORDetailsRegularCollection(ORNumber, Station, IssuingDate, "Destination");
                        ...
                        Session["ORReceiptName"] = "DestInvoiceCollection";
        ...
        protected void btnClear_Click(object sender, EventArgs e)
        {
            try
            {
                Response.Redirect("~/BillingDestAgentCollection.aspx");
            }
            catch (Exception)
            {
            }
