<%@ Page Title="" Language="C#" MasterPageFile="~/SmartCargoMaster.Master" AutoEventWireup="true" CodeBehind="rptAWBStockControlReport.aspx.cs" Inherits="ProjectSmartCargoManager.rptAWBStockControlReport" %>
...
<asp:Label ID="lblStatus" runat="server" BackColor="White" Font-Bold="True" Font-Size="Large" ForeColor="Red"></asp:Label>
        ...
        <table width="80%" cellpadding="2" cellspacing="2" >
            <tr>
                ...
                <td>
                    &nbsp;</td>
                <td >
                       <asp:DropDownList ID="ddlControlingLocator" runat="server" Visible="False" >   
           ...
           <%-- </tr>
            <tr>--%>
                ...
                <td>
                    ...
                    <asp:DropDownList ID="ddlCode" runat="server" Width="70px">
                    </asp:DropDownList>
                </td>
                <td>
                    &nbsp;</td>
    ...
    <%--<dd:webreportviewer ID="RptViewerStockControl" runat="server" Height="450px" 
            ...
            <rsweb:ReportViewer ID="AWBStockRptViewer" runat="server" Width="1024px" 
                >
            </rsweb:ReportViewer>           
