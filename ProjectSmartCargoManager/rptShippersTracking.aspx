<%@ Page Title="" Language="C#" MasterPageFile="~/SmartCargoMaster.Master" AutoEventWireup="true" CodeBehind="rptShippersTracking.aspx.cs" Inherits="ProjectSmartCargoManager.rptShippersTracking" %>
...
<td>
    ...
    <td>
    <asp:TextBox ID="txtShipperCode" runat="server" MaxLength="50" TabIndex="200" Width="77px" onchange="GetShipperCode(this);" 
