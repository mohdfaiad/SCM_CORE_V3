...
{
    public partial class rptAWBNotDelivered: System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!IsPostBack)
                {
                    Session["dsAWBNotDelivered"] = null;
        ...
        protected void btnList_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                res_Revenue = objReport.GetAWBNotDelivered(Origin,Destination,AgentCode,dtFrom,dtTo);
                    if (res_Revenue != null)
                    {
                        if (res_Revenue.Tables[0].Rows.Count > 0)
                        {
                            ...
                            Session["dsAWBNotDelivered"] = res_Revenue;
                            ...
                            AWBNotDepartedRptViewer.LocalReport.ReportPath = Server.MapPath("~/Reports/rptAWBNotDelivered.rdlc");
                            //Customers dsCustomers = GetData("select top 20 * from customers");
                            ReportDataSource datasource = new ReportDataSource("dsrptAWBNotDelivered_dtrptAWBNotDelivered", res_Revenue.Tables[0]);
        ...
        {
            e.DataSources.Add(new ReportDataSource("dsrptAWBNotDelivered_dtrptAWBNotDelivered_SUB", Dataset2.Tables[0]));
        }
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if ((DataSet)Session["dsAWBNotDelivered"] == null)
                    GetData();

                dsExp = (DataSet)Session["dsAWBNotDelivered"];
                ...
                string attachment = "attachment; filename=AWBNotDelivered.xls";
        ...
        private void SaveUserActivityLog(string ErrorLog)
        {
            ...
            objBAL.SaveUserActivityLog(Convert.ToString(Session["IpAddress"]), Session["UserName"].ToString(), "AWB Not Delivered", Convert.ToDateTime(Session["IT"]), Param, ErrorLog, Session["Station"].ToString());
        }
        ...
        {
            Response.Redirect("~/rptAWBNotDelivered.aspx");
        }
    }
}