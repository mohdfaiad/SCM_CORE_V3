<%@ Page Title="" Language="C#" MasterPageFile="~/SmartCargoMaster.Master" AutoEventWireup="true" CodeBehind="rptHigestCollectionsAndVolSales.aspx.cs" Inherits="ProjectSmartCargoManager.rptHigestCollectionsAndVolSales" %>
...
<asp:Label ID="lblStatus" runat="server" BackColor="White" Font-Bold="True" Font-Size="Large"></asp:Label>
 ...
 <h1>Revenue Report Collections/Sales</h1>
...
<td class="style1">Revenue By*</td>
<td class="style1">
<asp:DropDownList ID="ddlrevenueBy" runat="server">
...
<asp:ListItem Text="Lowest" Value="Asc"></asp:ListItem>
</asp:DropDownList>
</td>
