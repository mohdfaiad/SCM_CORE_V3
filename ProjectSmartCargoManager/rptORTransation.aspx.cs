...
{
    public partial class rptORTransaction : System.Web.UI.Page
    {
        ...
        private void GetStation()
        {
            ...
            try
            {
                ds = objBAL.GetOriginCodeList(ddlStation.SelectedValue);
                if (ds != null)
                {
                    if (ds.Tables != null)
                    {
        ...
        protected void btnList_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string Station = ddlStation.Text;
                string FOP = ddlFOP.Text;
                if (FOP != "All")
                {
                    string[] Arr = FOP.Split('-');
                    if (Arr.Length > 0)
                        FOP = Arr[0];
                }
                ...
                object[] param = { dt1.ToString("MM/dd/yyyy"), dt2.ToString("MM/dd/yyyy"), Station, FOP };
                string[] pname = { "FromDate", "ToDate", "Station", "FOP" };
                SqlDbType[] QueryTypes = { SqlDbType.DateTime, SqlDbType.DateTime, SqlDbType.VarChar, SqlDbType.VarChar };
                ...
                ds = da.SelectRecords("SP_GetORTransactionDetails", pname, param, QueryTypes);
                ...
                if (ds != null)
                {
                    if (ds.Tables[0].Rows.Count > 0)
                    {
                        ...
                        Session["dsORTransaction"] = ds;//.Tables[0];
                        //Logo
                        try
                        {
                        ...
                        ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Reports/ORTransaction.rdlc");
                        //Customers dsCustomers = GetData("select top 20 * from customers");
                        ReportDataSource datasource = new ReportDataSource("dsORTransaction_dtORTransactionDetails", dt);
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if ((DataSet)Session["dsORTransaction"] == null)
                    GetData();

                dt = (DataSet)Session["dsORTransaction"];
                ...
                if (Session["dsORTransaction"] == null && dt == null)
                {
                    lblStatus.Text = "No records found";
                    lblStatus.ForeColor = Color.Red;
