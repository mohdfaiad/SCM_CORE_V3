<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AirlineSchedule.aspx.cs" MasterPageFile="~/SmartCargoMaster.Master" Inherits="ProjectSmartCargoManager.AirlineSchedule" %>
...
.imgHover .hover { 
 ...
 <asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <table width="70%">
                    ...
                    <tr>
                        <td>
                            Flight #&nbsp; *</td>
                        <td>
                            <asp:TextBox ID="ddlFlight" runat="server" MaxLength="7" 
                            ...
                            <asp:TemplateField HeaderStyle-Wrap="false" HeaderText="Arrival Time  *" 
                                ...
                                <ItemTemplate>
                                    ...
                                    <asp:NumericUpDownExtender ID="NumericUpDownExtender_ArrivalDay" runat="server" 
                                        Maximum="4" Minimum="-1" RefValues="" ServiceDownMethod="" ServiceUpMethod="" 
    ...
    <Triggers>
   <asp:PostBackTrigger ControlID="btnSSIM" /></Triggers>
    </asp:UpdatePanel>
    </asp:Content>
