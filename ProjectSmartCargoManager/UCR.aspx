<%@ Page Language="C#" CodeBehind="UCR.aspx.cs" MasterPageFile="~/SmartCargoMaster.Master" Inherits="ProjectSmartCargoManager.UCR" AutoEventWireup="true" %>
    ...
    <table width="100%" cellpadding="3" cellspacing="3">
        ...
        <tr>
            ...
            <td>
                ...
                <asp:CalendarExtender ID="txtSfrmDate_CalendarExtender" Format="dd/MM/yyyy" runat="server" 
            ...
            <td>
                ...
                <asp:CalendarExtender ID="txtSToDate_CalendarExtender" runat="server"  Format="dd/MM/yyyy"
        ...
        <tr>
        <td>
            <asp:Button ID="btnListUCR" runat="server" CssClass="button"   Text="List" onclick="btnListUCR_Click" />
            &nbsp <asp:Button ID="btnClearList" runat="server" CssClass="button" Text="Clear" onclick="btnClearList_Click" />
            &nbsp <asp:Button ID="btnExport" runat="server" CssClass="button" Text="Export" onclick="btnExportList_Click" />
        </td>
        </tr>
        </table>
        <br />
...
<tr>
    ...
    <tr>
            ...
            <td class="style1">
                ...
                <asp:Button ID="btnSearch" runat="server" onclick="btnSearch_Click" CssClass="button"   Text="<%$ Resources:LabelNames, LBL_BTN_LIST %>" ValidationGroup="SEARCH" />    
                       </td>
            <td>
...
<RowStyle CssClass="RowStyle"></RowStyle>
         ...
         <EditRowStyle CssClass="grdrowfont"></EditRowStyle>
                    ...
                    <RowStyle CssClass="grdrowfont"></RowStyle>
                        ...
                        <asp:Button ID="btnUploadImage" runat="server" Text="<%$ Resources:LabelNames, LBL_BTN_UPLOADIMAGE %>" 
    ...
    <asp:Button ID="btnSave" runat="server" Text="<%$ Resources:LabelNames, LBL_BTN_SAVE %>" CssClass="button" 
            ...
            Text="<%$ Resources:LabelNames, LBL_BTN_PRINT %>" CssClass="button" onclick="btnPrint_Click" /> 
