...
{
    public partial class ListAirlineSchedule : System.Web.UI.Page
    {
        #region Variables
            ...
            if (!IsPostBack)
            {
                try
                {
                    ...
                    try
                    {
                        ...
                        grdFlight.PageSize = Convert.ToInt32(objConfig.GetMasterConfiguration("StdListPageSize"));
                        grdScheduleinfo.PageSize = Convert.ToInt32(objConfig.GetMasterConfiguration("StdListPageSize"));
                        objConfig = null;
                    }
                    catch (Exception ex)
                    { }
        ...
        protected void btnExport_Click(Object sender, EventArgs e)
        {
            try
            {
                DataSet ds = new DataSet("AirSch_dsexpt");
                DataTable dt = new DataTable("AirSch_dtexpt");
                getData();

                if (Session["ExpActSch"] != null)
                {

                    ds = (DataSet)Session["ExpActSch"];
                    dt = (DataTable)ds.Tables[0];
                    string attachment = "attachment; filename=AirlineSchedule.xls";
        ...
        private void getData()
        {
            try
            {
                ...
                try
                {
                    if (string.IsNullOrEmpty(txtFlightFromdate.Text) && string.IsNullOrEmpty(txtFlightToDate.Text))
                    {
                ...
                DataSet ds = OBJasb.GetExpAirlineSchedule(Source, Dest, FlightNo, ddlAirCraftType.SelectedValue, Flightfromdate, FlightToDate, ddlStatus.SelectedValue, strdomestic);
                if (ds != null && ds.Tables[0].Rows.Count > 0)
                {
                    Session["ExpActSch"] = ds;
                }
                else
                {
                    Session["ExpActSch"] = null;
        ...
        protected void btnList_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    lblStatus.Text = "Enter date range";
                    lblStatus.ForeColor = Color.Red;
                    return;
                }
                try
                {
                    if (txtFlightFromdate.Text.Trim() != "" || txtFlightToDate.Text.Trim() != "")
                    {
                        ...
                        //if (dt1.AddDays(8) < dt2)
                        //{
                        //    if (txtFlightNo.Text.Trim() == "")
                        //    {
                        //        lblStatus.ForeColor = Color.Red;
                        //        lblStatus.Text = "To list schedule of more than 8 days please enter Flight #";
                        //        txtFlightNo.Focus();
                        //        return;
                        //    }
                        //}
                        //else
                        //{
                        //    if (ddlAutoSource.SelectedIndex == ddlAutoSource.Items.Count - 1 &&
                        //        ddlAutoDest.SelectedIndex == ddlAutoDest.Items.Count - 1 &&
                        //        txtFlightNo.Text.Trim() == "")
                        //    {
                        //        lblStatus.ForeColor = Color.Red;
                        //        lblStatus.Text = "Please select either Origin or Destination or Flight #";
                        //        txtFlightNo.Focus();
                        //        return;
                        //    }
                        //}
        ...
        public string GetScheduleInterval(DateTime FromDate, DateTime ToDate)
        {
            ...
            {
                string strOutput = "";
                if (Session["MasterSchInterval"] == null)
                {
                    strOutput = objBL.GetMasterConfiguration("MasterSchInterval");
                    Session["MasterSchInterval"] = strOutput;
                }
                else
                {
                    strOutput = Session["MasterSchInterval"].ToString();
                }
        ...
        //#region Load DateWise Source in Gridview Dropdown
        //public void LoadDateWiseSourceInGridview()
        //{
        //    try
        //    {
        //        DataSet ds = OBJasb.GetOriginList("");
        ...
        //        {
        //            ddl = ((DropDownList)(GridView1.Rows[i].FindControl("ddlFromOrigin")));
        //            if (ds != null)
        //            {
        //                //Source in Gridview Dropdown
        //                DataRow row = ds.Tables[0].NewRow();
        ...
        private void LoadGridFlight()
        {
            try
            {
                ...
                DataSet ds = OBJasb.GetAirlineSchedule(ddlOrigin.Text, ddlDestination.Text, FlightNo, ddlAirCraftType.Text, Flightfromdate, FlightToDate, ddlStatus.Text,strdomestic);
        ...
        //#region Load datewise Dest in Gridview Dropdown
        //public void LoadDateWiseDestinationInGridview()
        //{
        //    try
        //    {
        //        DataSet ds = OBJasb.GetDestinationList("");
        ...
        //        for (int i = 0; i < GridView1.Rows.Count; i++)
        //        {
        //            ddl = ((DropDownList)(GridView1.Rows[i].FindControl("ddlToDest")));
        //            if (ds != null)
        //            {
        //                //LoadDest in Gridview Dropdown 
        //                DataRow row = ds.Tables[0].NewRow();
        ...
        private void AddRowToGrid()
        {
            try
            {
               ...
               if (ddlAutoDest.Text.Trim() != "" && ddlAutoDest.Text.Trim() != "Select")
               {
                ...
                DataSet ds = OBJasb.GetAirlineSchedule(Source, Dest, FlightNo, ddlAirCraftType.SelectedValue, Flightfromdate, FlightToDate, ddlStatus.SelectedValue, strdomestic);
                    ...
                    if (ds.Tables != null)
                    {
                        if (ds.Tables.Count > 0)
                        {
                            if (ds.Tables[0].Rows.Count > 0)
                            {
...

                                {
                                    ...
                                    for (int row = 0; row < Dtemp.Rows.Count; row++)
                                    {
                                        ...
                                        if (!arFlight.Contains(scheduleID))// + " " + Weekdays))//FlightID))//&& (!arOrigin.Contains(dtCurrentTable.Rows[i][1].ToString())))
                                        {
                                            ...
                                            ActDeptTimr = Convert.ToDateTime(ActDeptTimr).ToString("H:mm").Replace(':','.');
                               ...
                               // GroupBy("FlightID", "EquipmentNo", Dtemp);
                                ...
                                //if (Dtemp.Columns.Contains("SchDeptTime") && Dtemp.Columns.Contains("SchArrTime"))
                                //{
                                //    DataView dview = Dtemp.DefaultView; //mod vikas 1Aug

                                //    dview.Sort = "SchDeptTime,SchArrTime"; //mod vikas 1Aug
                                //    Dtemp = dview.ToTable();
                                //}
                               ...
                               // Dtemp = view.ToTable();
                                if (txtFlightNo.Text=="") //ddlFlight.SelectedItem.Text == "All" mod)
                                {
                                    ...
                                    if (dtCurrentTable.Rows.Count > 0)
                                    {
                                        ...
                                        for (int i = 0; i < grdScheduleinfo.Rows.Count; i++)
                                        {
                                            ...
                                            ((DropDownList)(grdScheduleinfo.Rows[i].FindControl("ddlAirCraft"))).SelectedValue = dtCurrentTable.Rows[j][17].ToString();
                                            ((DropDownList)(grdScheduleinfo.Rows[i].FindControl("ddlTailNo"))).SelectedValue = dtCurrentTable.Rows[j][18].ToString();
                                            ((TextBox)(grdScheduleinfo.Rows[i].FindControl("txtCapacity"))).Text = dtCurrentTable.Rows[j][16].ToString();
                                ...
                                else
                                {
                                    ...
                                    for (int i = 0; i < grdFlight.Rows.Count; i++)
                                    {
                                        ...
                                        lblRouteID.Text = "Route " + (j + 1); //dtCurrentTable.Rows[i][2].ToString();

                                        string FlightID = dtFlightTable.Rows[j][1].ToString();

                                        LinkButton lblFlight = ((LinkButton)(grdFlight.Rows[i].FindControl("lblFlightID")));
                                        lblFlight.Text = FlightID;
                                        arFlight.Add(FlightID);

                                        ((Label)grdFlight.Rows[i].FindControl("lblSource")).Text = dtFlightTable.Rows[j][2].ToString();

                                        ((Label)grdFlight.Rows[i].FindControl("lblDest")).Text = dtFlightTable.Rows[j][3].ToString();

                                        ((Label)grdFlight.Rows[i].FindControl("lblFromDate")).Text = DateTime.Parse(dtFlightTable.Rows[j][4].ToString()).ToString("dd/MM/yyyy");

                                        ((Label)grdFlight.Rows[i].FindControl("lblToDate")).Text = DateTime.Parse(dtFlightTable.Rows[j][5].ToString()).ToString("dd/MM/yyyy");
        ...
        private bool ValidateData()
        {
            try
            {
                if (ddlLoadAirCraftType.SelectedItem.Text == "Select")
                {
                    lblStatus.ForeColor = Color.Red;
        ...
        private void getFligtNo(string source)
        {
            try
            {
                DataSet ds = OBJasb.GetFlightList(source);
                if (ds != null)
                {
                    if (ds.Tables != null)
                    {
        ...
        protected void fillFlightDetails(int ind)
        {
            try
            {
                ...
                DataTable dt = (DataTable)ViewState["FlightTable"];
                 ...
                 scheduleid = Int64.Parse(dt.Rows[ind]["ScheduleID"].ToString());
                DataSet dsRoute = OBJasb.GetAirlineScheduleUsingRouteID(scheduleid);
                ...
                if (dsRoute.Tables[0].Rows.Count > 0)
                {
                    ...
                    if (dtCurrentTable.Rows.Count > 0)
                    {
                        ...
                        try
                        {
                            if (strAircraft != "")
                            {
                                ddlLoadAirCraftType.Text = dtCurrentTable.Rows[0]["AirCraftType"].ToString();
                            }
                        }
                        catch (Exception ex)
                        {
                    ...
                    //    txtSource.Text = dtCurrentTable.Rows[0][14].ToString();
                       ...
                       // txtDestination.Text = dtCurrentTable.Rows[0][15].ToString();
                        ...
                        for (int i = 0; i < grdScheduleinfo.Rows.Count; i++)
                        {
                            ...
                            try
                            {
                                ((DropDownList)(grdScheduleinfo.Rows[i].FindControl("ddlAirCraft"))).SelectedValue = dtCurrentTable.Rows[j][18].ToString();
                                 GetTailNumber(null, null);
        ...
        protected void btnclear_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                ddlAutoDest.SelectedValue = "Select";
                lblStatus.Text = string.Empty;
                OriginList();
                DestinationList();
                AirCraftType();
        ...
        #region grdFlight_PageIndexChanging
        ...
        #endregion grdFlight_PageIndexChanging

        //#region getTailNumber
        //public void GetTailNumber()
        //{
        ...
        //        {
        //            string AirCraftType = ((DropDownList)grdScheduleinfo.Rows[i].FindControl("ddlAirCraft")).SelectedItem.ToString();
        //            dsTail = OBJasb.GetTailNumber(AirCraftType);

        //            DropDownList ddlTailNo = (DropDownList)grdScheduleinfo.Rows[i].FindControl("ddlTailNo");

        //            if (dsTail != null && dsTail.Tables.Count > 0 && dsTail.Tables[0].Rows.Count > 0)
        //            {
        //                DataRow dr = dsTail.Tables[0].NewRow();
        //                ddlTailNo.Items.Clear();
        //                ddlTailNo.DataSource = dsTail;
        //                ddlTailNo.DataMember = dsTail.Tables[0].TableName;
        //                ddlTailNo.DataValueField = dsTail.Tables[0].Columns[0].ColumnName;
        //                ddlTailNo.DataTextField = dsTail.Tables[0].Columns[0].ColumnName;
        //                ddlTailNo.DataBind();
        //            }
        //        }
        //    }
        ...
        #region getTailNumber
        protected void GetTailNumber(object sender, EventArgs e)
        {
            DataSet dsTail = new DataSet();
            ...
            try
            {
                for (int i = 0; i < grdScheduleinfo.Rows.Count; i++)
                {
                    ...
                    if (dsTail != null && dsTail.Tables.Count > 0 && dsTail.Tables[0].Rows.Count > 0)
                    {
                        ...
                        ((DropDownList)grdScheduleinfo.Rows[i].FindControl("ddlTailNo")).DataValueField = "TailNo";
                        ((DropDownList)grdScheduleinfo.Rows[i].FindControl("ddlTailNo")).DataBind();
                        ((DropDownList)grdScheduleinfo.Rows[i].FindControl("ddlTailNo")).SelectedValue = "Select";
                    }
                }
            }
            catch (Exception ex)
