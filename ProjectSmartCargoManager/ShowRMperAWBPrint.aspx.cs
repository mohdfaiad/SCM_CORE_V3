...
{
    public partial class ShowRMperAWBPrint : System.Web.UI.Page
    {
        ReportDataSource rds1 = new ReportDataSource();
        DataTable dtTable1 = new DataTable();
        DataSet dsResult;
        BAL.BALRejectionMemo objBAL = new BAL.BALRejectionMemo();
        string format = "";
        ...
        {
            dsResult = objBAL.GetRMperAWBPrintDetails(AWBNum);
            //img for report
                    ...
                    if (dsResult.Tables.Count > 0)
                    {
                        if (dsResult.Tables[0].Rows.Count > 0)
                        {
                            try
                            {
                                ...
                                dsResult.Tables[2].Rows[0]["RM"].ToString(),
