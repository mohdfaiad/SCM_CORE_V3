...
{
    public partial class rptCarriageDGRGoods : System.Web.UI.Page
    {
        ...
        private void SaveUserActivityLog(string ErrorLog)
        {
            ...
            objBAL.SaveUserActivityLog(Convert.ToString(Session["IpAddress"]), Session["UserName"].ToString(), "Carriage Of Dangerous Goods", Convert.ToDateTime(Session["IT"]), Param, ErrorLog, Session["Station"].ToString());
        }
        ...
        public void GetData()
        {
            ...
            try
            {
                ...
                ds = da.SelectRecords("spCarriageDGRGoods", pname, param, QueryTypes);

                if (ds != null)
                {
                    if (ds.Tables[0].Rows.Count > 0)
                    {
                        Session["rptCarriageDGRGoods"] = ds.Tables[0];
        ...
        protected void btnList_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                Session["rptCarriageDGRGoods"] = null;
                ReportViewer1.Visible = false;
                DateTime dt1 = new DateTime();
                DateTime dt2 = new DateTime();
                try
                ...
                if (ds != null)
                {
                    if (ds.Tables[0].Rows.Count > 0)
                    {
                        ...
                        ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Reports/rptCarriageDGRGoods.rdlc");
                        ReportDataSource datasource = new ReportDataSource("dsrptCarriageDGRGoods_DataTable1", dt);
        ...
        {
            Response.Redirect("~/rptCarriageDGRGoods.aspx", false);
        }
        ...
        protected void btnExportReport_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if ((DataTable)Session["rptCarriageDGRGoods"] == null)
                    GetData();
         
                dt = (DataTable)Session["rptCarriageDGRGoods"];

                if (Session["rptCarriageDGRGoods"] == null && dt == null)
                {
                    lblStatus.Text = "No records found";
                    lblStatus.ForeColor = Color.Red;
                ...
                Session["rptCarriageDGRGoods"] = null;
                string attachment = "attachment; filename=CarriageDGRGoods.xls";
