<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmAWBTrackingMaster.aspx.cs" MasterPageFile="~/SmartCargoMaster.Master" Inherits="ProjectSmartCargoManager.frmAWBTrackingMaster" %>
...
<div id="contentarea">
    ...
    <asp:Label ID="LabelStatus"  runat="server" Font-Bold="true" Font-Size="Medium" ></asp:Label>
     ...
     <asp:Label ID="lblPrintDO" Text="Print DO: " Font-Bold="true" runat="server"></asp:Label>
          ...
          <asp:Label ID="lblIsCollect" runat="server" ></asp:Label>
       </div>
            </asp:Panel>
       </div>
    </div>
