<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CustomFltPlannerTab.ascx.cs"
    Inherits="ProjectSmartCargoManager.CustomFltPlannerTab" %>
        ...
        <tr>
            ...
            <asp:Label ID="lblStatus" runat="server" ForeColor="Red" Font-Bold="True" Font-Size="Large"></asp:Label>
                <asp:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="0" Font-Size="Medium"
                    ...
                    <asp:TabPanel ID="tbFlight" runat="server" HeaderText="Flights" Width="620px" Height="27px">
                        <HeaderTemplate>
                            Flights</HeaderTemplate>
                        <ContentTemplate>
                    ...
                    <%--<asp:TabPanel ID="tbPendingConfirmation" runat="server" HeaderText="Pending AWB" Width="620px" Height="27px">
                        <HeaderTemplate>
                            Pending AWB
                        </HeaderTemplate>
                        <ContentTemplate>
                                ...
                                <table width="100%">
                                    <tr>
                                        <td>
                                            ...
                                            <asp:Button ID="btnFlightList" Text="List" runat="server" class="button" OnClick="GetData_Click" />
                                        </td>
                                    </tr>
                                </table>
                                <div style="width: 630px; height: 250px; overflow: auto;">
                                    <asp:GridView ID="grdAWBDetailsFlightWise" runat="server" AutoGenerateColumns="false">
                                        <Columns>
                                            <asp:TemplateField HeaderText="AWB #">
                                                <ItemTemplate>
                                                    <asp:HyperLink ID="hlnkAWBNumber" runat="server" Width="100px" Text='<%#Eval("AWBNumber") %>' NavigateUrl='<%# "~/GHA_ConBooking.aspx?command=Edit&AWBNumber=" + Eval("AWBNumber")%>'></asp:HyperLink>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:BoundField DataField="AcceptedPcs" HeaderText="AcceptedPcs">
                                                <ItemStyle Width="100px" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="AcceptedWt" HeaderText="AcceptedWt">
                                                <ItemStyle Width="100px" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="BookingStatus" HeaderText="Booking Status">
                                                <ItemStyle Width="100px" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="ConfirmationStatus" HeaderText="Confirmation Status">
                                                <ItemStyle Width="100px" />
                                            </asp:BoundField>                                            
                                        </Columns>
                    ...
                    <asp:TabPanel ID="tbPendingConfirmation" runat="server" HeaderText="Agents" Width="620px" Height="27px">
                        <HeaderTemplate>
                            &nbsp; Revenue &nbsp;
                        </HeaderTemplate>
                        <ContentTemplate>
                    ...
                    <asp:TabPanel ID="tbSpotRates" runat="server" HeaderText="Spot Rates"
                        Width="620px" ScrollBars="Auto" Height="27px">
                        <HeaderTemplate>
                            Spot Rates
                        </HeaderTemplate>
                        <ContentTemplate>
                            <asp:Panel ID="Panel4" runat="server" Width="100%">
                                <div style="overflow: auto; height: 300px">
                                    <asp:GridView ID="grdSpotRate" runat="server" ShowFooter="false" Width="80%"
                                        AutoGenerateColumns="False" BorderColor="#BFBEBE" BorderStyle="None" CellPadding="2"
                                        CellSpacing="3" PageSize="10" AllowPaging="false">
                                        <Columns>
                                            <asp:TemplateField HeaderText="Spt Rate Id" HeaderStyle-Wrap="true">
                                                <ItemTemplate>                                                    
                                                    <asp:Label ID="lblSptRateId" Width="150px" runat="server" Text='<%#Eval("SpotRateID") %>'/>
                                                </ItemTemplate>
                                                <HeaderStyle Wrap="True"></HeaderStyle>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Spt Rate" HeaderStyle-Wrap="true">
                                                <ItemTemplate>                                                    
                                                    <asp:Label ID="lblSptRate" runat="server" Text='<%#Eval("SpotRate") %>'/>
                                                </ItemTemplate>
                                                <HeaderStyle Wrap="True"></HeaderStyle>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Agent" HeaderStyle-Wrap="true">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblAgent" runat="server" Text='<%# Eval("AgentCode")%>' />
                                                </ItemTemplate>
                                                <HeaderStyle Wrap="True"></HeaderStyle>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Flt #" HeaderStyle-Wrap="true">
                                                <ItemTemplate>                                                    
                                                    <asp:Label ID="lblFlightNo" runat="server" Text='<%#Eval("FlightNumber") %>'/>
                                                </ItemTemplate>
                                                <HeaderStyle Wrap="True"></HeaderStyle>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Flt Dt." HeaderStyle-Wrap="true">
                                            ...
                                            <asp:TemplateField HeaderText="Commodity" HeaderStyle-Wrap="true">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblBooked" runat="server" Text='<%# Eval("Commodity") %>' />
                                                </ItemTemplate>
                                                <HeaderStyle Wrap="True"></HeaderStyle>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Approval" HeaderStyle-Wrap="true">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblBookedWt" runat="server" Text='<%# Eval("Aproval") %>' />
                                                </ItemTemplate>
                                                <HeaderStyle Wrap="True"></HeaderStyle>
                                            </asp:TemplateField>
                                        </Columns>
