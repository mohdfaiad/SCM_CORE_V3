<%@ Page Language="C#" MasterPageFile="~/SmartCargoMaster.Master" AutoEventWireup="true" CodeBehind="ePouchFlights.aspx.cs" Inherits="ProjectSmartCargoManager.ePouchFlights" %>
        ...
        <asp:GridView ID="grdePouch" runat="server" AutoGenerateColumns="False" 
                    ...
                    <ItemStyle Width="30%" />
                        <ItemTemplate>
                            <asp:Label ID="lblUploadedFiles" runat="server"  
                                Text='<%# Eval("UploadedFiles").ToString().Length>25?Eval("UploadedFiles").ToString().Substring(0,20)+"..":Eval("UploadedFiles") %>' ToolTip='<%# Eval("UploadedFiles") %>'  ></asp:Label>
                        </ItemTemplate>
                        <HeaderStyle Wrap="True" />
                        <ItemStyle Wrap="True" HorizontalAlign="Center" />
                    </asp:TemplateField>
            ...
            ValidationExpression="^.+\.((jpg)|(JPG)|(gif)|(GIF)|(jpeg)|(JPEG)|(png)|(PNG)|(bmp)|(BMP)|(pdf)|(PDF)|(xls)|(XLS)|(xlsx)|(XLSX)|(docx)|(DOCX)|(doc)|(DOC))$" />
                 ...
                 onclick="btnUpload_Click" CommandArgument='<%# Eval("SerialNumber") %>'  />
                    ...
                    <asp:Label ID="FlightsDocumentType" runat="server" Text='<%# Eval("DocumentType") %>' />
