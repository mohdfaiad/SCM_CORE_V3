<%@ Page Title="" Language="C#" MasterPageFile="~/SmartCargoMaster.Master" AutoEventWireup="true" CodeBehind="rptGSAInterlineRevenue.aspx.cs" Inherits="ProjectSmartCargoManager.rptGSAInterlineRevenue" %>
...
<asp:ListItem Value="INT">International</asp:ListItem>
                ...
                <td>
                    GSA Code</td>
                <td>
                    <asp:TextBox ID="txtGSACode" runat="server" onchange="GetCommodityCode(this);"></asp:TextBox>
   ...
   MinimumPrefixLength="1" ServiceMethod="GetAgentCodesWithName" 
TargetControlID="txtGSACode" OnClientPopulated="onCommListPopulated" FirstRowSelected="true">
