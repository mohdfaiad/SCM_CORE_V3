...
<%@ Page Title="" Language="C#" MasterPageFile="~/SmartCargoMaster.Master" AutoEventWireup="true" CodeBehind="rptFlightWiseTonnageReport.aspx.cs" Inherits="ProjectSmartCargoManager.rptFlightWiseTonnageReport" %>
...
<asp:Label ID="lblStatus" runat="server" BackColor="White" Font-Bold="True" Font-Size="Large"></asp:Label>
        ...
        <table width="90%" cellpadding="2" cellspacing="2" >
            ...
            <tr>
                <td>
                        &nbsp;</td>
                <td>
                        <asp:RadioButton ID="rbSummaryReport" runat="server" GroupName="A" 
                        Text="Summary Report" Checked="True"/>
                        &nbsp;
                        <asp:RadioButton ID="rbDetailedReport" runat="server" GroupName="A" 
                        Text="Detail Report" />
                    &nbsp;</td>
                <td>
                    &nbsp;</td>
  ...
  <rsweb:ReportViewer ID="FlightPerformanceRptViewer" runat="server" 
                Width="1022px">
            </rsweb:ReportViewer>
            <rsweb:ReportViewer ID="FlightPerformanceRptViewer_Detail" runat="server" Width="1022px">
            </rsweb:ReportViewer>
