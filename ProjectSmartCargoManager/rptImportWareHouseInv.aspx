<%@ Page Title="WareHouse Inventory Import" Language="C#" MasterPageFile="~/SmartCargoMaster.Master" AutoEventWireup="true" CodeBehind="rptImportWareHouseInv.aspx.cs" Inherits="ProjectSmartCargoManager.rptImportWareHouseInv" %>
...
<asp:Label ID="lblStatus" runat="server" BackColor="White" Font-Bold="True" Font-Size="Large"></asp:Label>
   ...
   <h1> 
            &nbsp;WareHouse Inventory Import</h1>
         <p>
                <%--<asp:Label ID="lblStatus" runat="server" BackColor="White" Font-Bold="True" Font-Size="Large"
                ForeColor="Red"></asp:Label>--%>
            </p>
 
<asp:Panel ID="pnlNew" runat="server"><table width="75%" border="0">
    ...
    <tr>
        ...
        <td>
            &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;
            <%--<asp:Button ID="btnEx" runat="server" CssClass="button" Text="Test" 
                    onclick="btnEx_Click" />--%>
        </td>
    </tr>
    <tr>
...
<div>
    <asp:GridView ID="grdimpList" runat="server" ShowFooter="false" Width="80%" 
            AutoGenerateColumns="False" BorderColor="#BFBEBE" BorderStyle="None" 
            CellPadding="2" CellSpacing="3" PageSize="10" AllowPaging="True" 
           onpageindexchanging="grdimpList_PageIndexChanging" 
        onrowcommand="grdimpList_RowCommand">
