<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="~/ListMultiplePackagingCharges.aspx.cs" Inherits="ProjectSmartCargoManager.ListMultiplePackagingCharges" %>
...
<body style="background:#fff;">
        ...
        <asp:GridView ID="GRD" runat="server" AutoGenerateColumns="False" EnableViewState="true"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Pieces" HeaderStyle-Wrap="true">
                    <ItemTemplate>
                        <asp:TextBox ID="txtPieces" runat="server"  EnableViewState="true"></asp:TextBox>
                    </ItemTemplate>
                   <HeaderStyle Wrap="true"></HeaderStyle>
                    <ItemStyle Wrap="true"/>
                </asp:TemplateField>
    ...
    <asp:HiddenField ID="hdnPieces" runat="server" />
    </div>
    </form>
</body>
</html>
